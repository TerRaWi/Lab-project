...
class ServerScene extends Phaser.Scene {
  ...
  preload() {
    this.load.tilemapTiledJSON("map", "../gameclient/assets/map.json");
    this.load.image("rect", "../gameclient/assets/rect.png");
    this.load.image("platform", "../gameclient/assets/tilesheet.png");

  }
  create() {
    console.log("Server is created.");
    var charactor_names = ["01", "02", "03","04"];
    ...
    const tileset = this.map.addTilesetImage("tilesheet", "platform");
